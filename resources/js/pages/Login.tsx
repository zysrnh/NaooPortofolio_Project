      ...
      >
        ...
        <div className="anim-card w-full max-w-md bg-[var(--nb-bg)] border-4 border-[var(--nb-primary)] shadow-[10px_10px_0_var(--nb-primary)] overflow-hidden z-10">
          ...
          <div className="bg-[var(--nb-primary)] px-8 py-6">
            <p className="text-[var(--nb-accent)] font-black uppercase text-xs tracking-[0.3em] mb-1">Welcome Back</p>
            <h1 className="text-3xl font-black uppercase text-[var(--nb-bg)]">Login</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-8 flex flex-col gap-5">
            ...
            {/* General error */}
            {errors.general && (
              <div className="err-shake border-4 border-[var(--nb-primary)] bg-[#FFD1D1] p-4 flex items-center gap-3">
                <IconWarning />
                <p className="font-black text-[var(--nb-primary)] text-sm uppercase tracking-wide">{errors.general}</p>
              </div>
            )}
        ...
        <p className="anim-foot mt-6 font-bold text-xs text-[var(--nb-primary)] uppercase tracking-widest opacity-50 z-10">
