                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr className="bg-[var(--nb-primary)] text-[var(--nb-accent)] border-b-4 border-[var(--nb-primary)]">
                            <th className="p-4 text-left font-black uppercase text-[10px] tracking-widest border-r-2 border-[var(--nb-bg)]">Name</th>
                            <th className="p-4 text-left font-black uppercase text-[10px] tracking-widest border-r-2 border-[var(--nb-bg)]">Email</th>
                            <th className="p-4 text-left font-black uppercase text-[10px] tracking-widest border-r-2 border-[var(--nb-bg)]">Role</th>
                            <th className="p-4 text-left font-black uppercase text-[10px] tracking-widest border-r-2 border-[var(--nb-bg)]">Joined</th>
                            <th className="p-4 text-center font-black uppercase text-[10px] tracking-widest">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {users.map((user, i) => (
                            <tr key={user.id} className="border-b-2 border-[var(--nb-primary)] hover:bg-[var(--nb-accent-light)] transition-colors" style={{ animationDelay: `${i * 0.05}s` }}>
                                <td className="p-4 font-black text-sm text-[var(--nb-primary)] border-r-2 border-[var(--nb-primary)]">
                                    {user.name}
                                </td>
                                <td className="p-4 font-bold text-xs text-[var(--nb-primary)] opacity-70 border-r-2 border-[var(--nb-primary)]">
                                    {user.email}
                                </td>
                                <td className="p-4 border-r-2 border-[var(--nb-primary)]">
                                    <span className={`px-2 py-1 font-black text-[9px] uppercase border-2 border-[var(--nb-primary)] ${user.role === 'admin' ? 'bg-[var(--nb-accent)] text-[var(--nb-primary)] shadow-[2px_2px_0_var(--nb-primary)]' : 'bg-white text-[var(--nb-primary)]'}`}>
                                        {user.role}
                                    </span>
                                </td>
                                <td className="p-4 font-bold text-[10px] text-[var(--nb-primary)] opacity-50 border-r-2 border-[var(--nb-primary)]">
